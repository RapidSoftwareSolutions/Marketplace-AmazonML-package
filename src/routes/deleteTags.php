...
$app->post('/api/AmazonML/deleteTags', function ($request, $response, $args) {
    
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','region','resourceId','resourceType','tagKeys']);
